...
import br.com.stant.mobile.challenge.domain.use_case.GetMoviesDbUseCase
...
class MoviesViewModel(
    ...
    var getMoviesDbUseCase: GetMoviesDbUseCase
) : ViewModel() {
    ...
    fun getMoviesDb() {
        ...
        viewModelScope.launch {
            val result = getMoviesDbUseCase()
            _moviesList.value = result
        }
    }

    private fun insertMovies(moviesList: List<Result>) {
